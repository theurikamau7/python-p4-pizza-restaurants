...
class RestaurantPizzaResource(Resource):
    ...
    def get_all(self):
        ...
        for restaurant_pizza in restaurant_pizzas:
            ...
            restaurant_pizza_list.append(restaurant_pizza_obj)
    ...
    def post(self):
        ...
        if restaurant_id and pizza_id and price:
    ...
    def put(self, id):
        ...
        if restaurant_pizza:
            ...
            if price:
                ...
                response = make_response(jsonify({'message': 'RestaurantPizza updated successfully'}), 200)
            else:
                response = make_response(jsonify({'error': 'Missing required fields'}), 400)
        else:
            response = make_response(jsonify({'error': 'RestaurantPizza not found'}), 404)
    ...
    def delete(self, id):
        ...
        if restaurant_pizza:
            ...
            response = make_response(jsonify({'message': 'RestaurantPizza deleted successfully'}), 200)
        else:
            response = make_response(jsonify({'error': 'RestaurantPizza not found'}), 404)
